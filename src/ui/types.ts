...
export interface UiState {
  ...
  capWidthMm: number; topThickness: number; imageDepth: number; imageMargin: number; borderWidth: number;
  ...
  smoothing: number; keychain: KeychainParams; removeBg: boolean; view: ViewMode; showSwitch: boolean;
...
export interface UiCallbacks {
  ...
  onImageMargin(mm: number): void; onBorderWidth(mm: number): void;
  ...
  onRemoveBg(on: boolean): void; onView(mode: ViewMode): void; onShowSwitch(on: boolean): void;
