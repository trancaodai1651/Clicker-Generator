...
export function setupTutorial() {
  ...
  const backdrop = document.createElement('div'); backdrop.className = 'tutorial-backdrop';
  const cardContainer = document.createElement('div'); cardContainer.className = 'tutorial-card-container';
...
export function showTutorialPrompt() {
  ...
  const wm = document.createElement('div'); wm.className = 'welcome-overlay';
  wm.innerHTML = `
